 ...
 * Aufgabe:
 * 
 * Dieser Server startet einen neuen Platform Thread fuer jeden Request.
 * 
 * a) Zeige, dass der Server abstürzt, wenn zu viele Requests in zeit ankommen.
 *    Nutze dafür den ClientVirtualThread_BASE.
 *    
 * b) Zeige, dass durch Nutzung von Virtual Threads anstelle von Platform Threads 
 * 	  das Problem behoben werden kann. Der Server ist nun "skalierbarer"	
 * 
 * (Dieses Beispiel ist vereinfcht und impelemntiert keinen realistischen Server!)
 * 
 * 
 ...
 */
public class ServerVirtualThread_BASE {
	...
	public static void main(String[] args) throws IOException {
		ServerVirtualThread_BASE serverInstance = new ServerVirtualThread_BASE();
	...
	void startListenig() {
		...
		try {
			...
			while(true) {
				...
				// TODO: Dies ist die entscheidende Stelle um zwischen Virtual und Platform Thread zu
				// unterscheiden: 
